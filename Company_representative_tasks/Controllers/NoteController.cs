...
namespace Argent_Company.Controllers
{
    ...
    public class NoteController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("Id,Content,CreatedAt,AgentId")] Note note)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Content,CreatedAt,AgentId")] Note note)
        {
            if (id != note.Id)
            {
                return NotFound();
